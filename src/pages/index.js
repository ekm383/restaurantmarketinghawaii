...
const IndexPage = () => (
  <Layout>
    ...
    >
      <Section>
        <Intro heading="digital marketing package" subheading="Your customers will never leave your website when ordering online. With menu images, upsales, and social media integration, get the world's most powerful online ordering solution." />
        <Features
        ...
        <Section style={{
          width: '800px', justifyContent: 'flex-start', marginTop: '1rem'
        }}
        >
          <Link to="/sign-up">
