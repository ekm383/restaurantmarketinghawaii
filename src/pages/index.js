...
const IndexPage = () => (
  <Layout>
    ...
    <Section
      ...
      style={{ height: "100vh" }}
    >
      <Intro heading="marketing package" subheading="Your customers will never leave your website when ordering online. With menu images, upsales, and social media integration, get the world's most powerful online ordering solution." />
      <Features
